...
var OflIcon = icons.createFromIconfontCN({
...
var OflIcon$1 = (function (_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(OflIcon, _objectSpread2({
    type: "".concat(type),
...
var GlobalDndContext = /*#__PURE__*/React__default['default'].memo(function (_ref) {
...
function select(props) {
  ...
  var _useState3 = React.useState([/*#__PURE__*/React__default['default'].createElement(icons.DownOutlined, null)]),
  ...
  var title = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(antd.Checkbox, {
    ...
    onOpenChange: function onOpenChange(o) {
      if (o) {
        setOnIcon([/*#__PURE__*/React__default['default'].createElement(icons.UpOutlined, null)]);
      } else {
        setOnIcon([/*#__PURE__*/React__default['default'].createElement(icons.DownOutlined, null)]);
      }
    }
  ...
  }, /*#__PURE__*/React__default['default'].createElement(antd.Space, null, onIcon))));
  if (treeMode) {
    if (mode === 'checkbox') {
      return aliReactTable.features.treeSelect({
        tree: dataSource,
        rootKey: 'root',
    ...
    if (mode === 'checkbox') {
      if (isSelectCheck) {
        ...
        return aliReactTable.features.multiSelect({
          value: value,
          onChange: _onChange,
          // clickArea: 'row',
          checkboxColumn: {
    ...
    if (mode === 'radio') {
      return aliReactTable.features.singleSelect({
        // defaultValue: '1',
        highlightRowWhenSelected: true,
        clickArea: 'row'
      });
...
var AntEmptyContent = /*#__PURE__*/React__default['default'].memo(function () {
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(antd.Empty, {
    imageStyle: {
      height: 'auto'
    },
    ...
    }, /*#__PURE__*/React__default['default'].createElement(OflIcon$1, {
      type: "noData"
    })),
    description: "\u6682\u65E0\u6570\u636E"
  }));
...
var OflBaseTable = function OflBaseTable(props, ref) {
  ...
  // 排序
  pipeline.use(aliReactTable.features.sort({
    mode: 'single',
    highlightColumnWhenActive: true
  }));
  // 启动树形同时开启树形选择
  if (selectMode === null || selectMode === void 0 ? void 0 : selectMode.treeMode) {
    pipeline.use(aliReactTable.features.treeMode({
      clickArea: 'cell'
    }));
  }
  // // 行列滑上高亮
  ...
  // 提示信息
  pipeline.use(aliReactTable.features.tips());
  // 拖拽调整列宽
  if (columnResize) {
    pipeline.use(aliReactTable.features.columnResize({
      fallbackSize: 120,
  ...
  return /*#__PURE__*/React__default['default'].createElement(GlobalDndContext, null, isActionBar ? ( /*#__PURE__*/React__default['default'].createElement("div", {
    style: {
      position: 'sticky',
      top: 0,
      height: 48,
    ...
    className: "buttonAll"
  }, actionBar))) : null, /*#__PURE__*/React__default['default'].createElement(aliReactTable.BaseTable, _objectSpread2(_objectSpread2(_objectSpread2({
...
var OflTable = function OflTable(_ref, ref) {
  ...
  // 当前右键的区域
  var _useState = React.useState('body'),
    _useState2 = _slicedToArray(_useState, 2),
  ...
  // 底部全选
  var footerSelectedContentRef = React.useRef(null);
  // 底部反选
  var footerReversSelectContentRef = React.useRef(null);
  return /*#__PURE__*/React__default['default'].createElement("div", {
    style: {
      display: 'flex',
  ...
  }, /*#__PURE__*/React__default['default'].createElement(OflBaseTable, _objectSpread2(_objectSpread2({}, props), {}, {
    actionBar: actionBar,
...
exports.DumiBigCalendar = OflTable;
exports.DumiIcon = OflIcon$1;
exports.DumiTable = OflTable;
exports.Foo = index;
